...
(script dormant mission_cave
	...
	(sleep_until (volume_test_objects cave_floor_after (players)) 15)
	(wake save_cave_floor_exit)
	(ai_place cave_afterparty)

	(sleep_until (volume_test_objects cave_floor_exit (players)) 15)
	(ai_place cave_carriers/tunnel_front_runners)
	(sleep 60)
	(ai_place cave_carriers/tunnel_front)
;	(ai_conversation second_driving)

	(sleep_until (volume_test_objects cave_tunnel (players)) 15)
	(ai_place cave_carriers/tunnel_back)
	(ai_magically_see_players cave_carriers/tunnel_back)
...
;	(ai_conversation_stop cliff_welcome)
	...
	(cond ((or (volume_test_objects cliff_all jeep)
			 ...
			 (volume_test_objects cliff_all jeep_field2)
			 ) (sleep 1))
		 (mark_jeep3 (sleep 1))
	...
	(cond ((game_is_cooperative) (sleep 1))
		 ...
		 ((volume_test_objects cliff_all jeep_field2) (ai_go_to_vehicle cliff_marine jeep_field2 "gunner"))
		 )
	(cond ((game_is_cooperative) (sleep 1))
		 ...
		 ((volume_test_objects cliff_all jeep_field2) (ai_go_to_vehicle cliff_marine jeep_field2 "passenger"))
		 )
...
;	(ai_kill final_banshee)
	...
	(cond ((or (volume_test_objects rubble_all jeep)
			 ...
			 (volume_test_objects rubble_all jeep_field2)
			 ) (sleep 1))
		 (mark_jeep3 (sleep 1))
	...
	(cond ((game_is_cooperative) (sleep 1))
		 ...
		 ((volume_test_objects rubble_all jeep_field2) (ai_go_to_vehicle rubble_marine jeep_field2 "gunner"))
		 )
	(cond ((game_is_cooperative) (sleep 1))
		 ...
		 ((volume_test_objects rubble_all jeep_field2) (ai_go_to_vehicle rubble_marine jeep_field2 "passenger"))
		 )
...
;	(ai_kill final_banshee)
	...
	(cond ((or (volume_test_objects river_all jeep)
			 ...
			 (volume_test_objects river_all jeep_field2)
			 ) (sleep 1))
		 (mark_jeep3 (sleep 1))
	...
	(cond ((game_is_cooperative) (sleep 1))
		 ...
		 ((volume_test_objects river_all jeep_field2) (ai_go_to_vehicle river_marine jeep_field2 "gunner"))
		 )
	(cond ((game_is_cooperative) (sleep 1))
		 ...
		 ((volume_test_objects river_all jeep_field2) (ai_go_to_vehicle river_marine jeep_field2 "passenger"))
		 )
