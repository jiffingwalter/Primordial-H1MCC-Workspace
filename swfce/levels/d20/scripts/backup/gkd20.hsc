...
(if (and (< enc4_2_limiter (* 40 spawn_scale ))(volume_test_objects enc4_2b (players )))
(object_create_anew 2_6jumpscare )
(begin (if (< (ai_living_count enc4_2 )(+ (ai_living_count enc4_2/carriers1 )min_carrier_spawn ))
(begin (if (objects_can_see_flag (players )enc4_2_forward 30 )(ai_spawn_actor enc4_2/carriers_rear )(ai_spawn_actor enc4_2/carriers_front ))(set enc4_2_limiter (+ enc4_2_limiter 1 ))))
(if (< (ai_living_count enc4_2/infs )min_infection_spawn )(ai_place enc4_2/infs )(print "foo" ))))(sleep 200 ))
