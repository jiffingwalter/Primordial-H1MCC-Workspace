...
(script static void ini_interior_b_cleanup
	(ai_erase_all)
	(objects_delete_by_definition "swfce\levels\c10\devices\door_small_bashed\door_small_bashed")
	...
	(objects_delete_by_definition "swfce\levels\c10\devices\bridge\bridge")
	(objects_delete_by_definition "swfce\levels\c10\devices\falling lift\falling lift")
...
;	(wake ini_interior_c_cleanup)
	...
	(sleep_until (volume_test_objects int_b_hall_g_trigger_c (players)))
