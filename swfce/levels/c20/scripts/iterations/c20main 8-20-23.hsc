...
(script dormant enc_dance_egg
	...
	; if player kills too many homies or the king, sick em on the player
	(sleep_until 
		(or
			(< (ai_living_fraction party_rats) 1.3)
			(< (ai_strength party_rats/ratking) .9)
		)
	)
...
(script dormant enc_morshu
	...
	(sound_impulse_start "swfce\sound\dialog\morshu\morshu intro" (list_get (ai_actors morshu) 0) 1)
	(sleep (max 0 (- (sound_impulse_time "swfce\sound\dialog\morshu\morshu intro") 60)))
	(object_create morshu_control)
	
	(sleep_until (< 0 (device_group_get morshu_deal)) 1)
	(if debug (print "Morshu egg - Morshu refusal line"))
	(sound_impulse_start "swfce\sound\dialog\morshu\morshu refuse sale" (list_get (ai_actors morshu) 0) 1)
...
(script dormant cameramode_trigger
	...
	(print "Camera mode enabled, spawning cameras...")
