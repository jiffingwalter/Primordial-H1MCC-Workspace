...
(script continuous enc6_4_spawner
	...
	(if 
		...
		; Check the infection form count. If it is too low, spawn along with carrier(s)
		(if (< (ai_living_count enc6_4/infs) min_infection_spawn)
			; Spawn 'em and increment the count
			(ai_place enc6_4/infs)
			(ai_place enc6_4/carriers)
		)
		)
	)	 
)
...
(script startup mission
	...
	(ai_allegience flood unused6)
	(ai_allegience sentinel unused6)
	(ai_allegience player unused6)
