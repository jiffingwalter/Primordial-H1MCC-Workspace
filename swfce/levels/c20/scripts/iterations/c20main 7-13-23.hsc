...
;- Encounter skips
(script static void skiptoenc3_4 ; locked door waves on second level
...
(script static void skiptoenc5_5 ; locked door waves on third level
...
(script static void skiptoenc6_4 ; locked room with amogus waves
...
(script static void skiptoenc7_9 ; 4th floor, pre boss room
...
(script startup mission
	;turn on debug -- TURN OFF FOR RELEASE
	(set debug true)
	...
	;prim; set normal rats to be friendly
