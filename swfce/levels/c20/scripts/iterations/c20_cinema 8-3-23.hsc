...
;	(90, block is touched, create effect and sounds, attach sparkles to star)
...
(script static void index_animate
	(scenery_animation_start index swfce\scenery\index_holder\index_holder C20GrabIndex)
	(print "starting index animation...")
	
	; 318 - block is bumped, make sfx and spawn light
	(sleep_until (< (scenery_get_animation_time index) 318))
	(print "index hit frame 90, making fx...")
	(effect_new_on_object_marker "swfce\scenery\index_holder\effects\index block bump" index "fx block")
	(effect_new_on_object_marker "swfce\scenery\index_holder\effects\index sparkles 10sec" index "fx star")
)