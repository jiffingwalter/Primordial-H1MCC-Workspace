...
;	(certain_save)
	...
	; if egg was triggered, turn music back on
...
(script dormant enc_dance_egg
	...
	; if player attacks king or kills any small fry, enemy on player and have king attack
	(sleep_until
		(or
			(= "4" (ai_status party_rats/ratking))
			(not (ai_living_fraction party_rats) 1)
		)
	)
	...
	(ai_set_deaf party_rats 0)
	(ai_set_blind party_rats 0)
)
