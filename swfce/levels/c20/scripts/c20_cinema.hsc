...
(script static void cutscene_insertion
	; kill cinematic indexes in case they appear for some reason
	...
	(sound_impulse_start swfce\sound\dialog\jerma\c20\C20_insert_020_Monitor monitor 1)
...
(script static void cutscene_extraction_easy ;final cutscene if on easy ----------------------------------------------------------------------------------
	...
	(sound_looping_start swfce\sound\sfx\cinematic\c20\c20_extraction_foley none 1)
	...
	(sleep 3)
	(sound_looping_start sound\sinomatixx_music\c20_extraction_music none .7)
	(sleep 57)
	...
	;(sound_impulse_start swfce\sound\dialog\jerma\c20\C20_310_Monitor none 1) ;"what the fuck is happening!?"
	(print "monitor: what the fuck is happening?? ... oh god i broke it ... how are we gonna handle this situation")
;	(sleep (sound_impulse_time sound\dialog\c20\C20_310_Monitor))
	...
	; start index section
	(sound_looping_start swfce\levels\c20\music\c20_ending none 1)
	(object_destroy index_idle)
	(object_create index)
	(object_create index_fx)
	...
	(scenery_animation_start index_fx swfce\scenery\index_holder\index_holder C20GrabIndex)

	(camera_set grab_index_1a 0)
	(camera_set grab_index_1b 400)
	
	(sound_impulse_start swfce\sound\dialog\jerma\c20\C20_320_Monitor monitor 1)
	(print "monitor: if you think im gonna eat this, you're out of your mind")
	
	(sleep 200)
	
	(camera_set grab_index_1c 200)
	
;	(405, chief grabs index, create sound)	
	(sleep 205)
...
;	(535, make index disappear)
	...
	(sound_impulse_start swfce\sound\dialog\jerma\c20\C20_extract_020_Monitor monitor 1)
	(print "monitor: now i look like a fuckin idiot")
	(sleep (- (sound_impulse_time swfce\sound\dialog\jerma\c20\C20_extract_020_Monitor) 60))
	...
	(sound_looping_stop swfce\levels\c20\music\c20_ending)
	...
	(sound_impulse_start swfce\sound\dialog\jerma\c20\C20_extract_030_Monitor none 1)
;	(print "monitor: The Flood is spreading. We must hurry.") ;"i fucked that up, not gonna lie"
...
;	(sleep (sound_impulse_time sound\dialog\c20\C20_310_Monitor))
	...
	(object_destroy index_idle)
	(object_create index)
	(object_set_permutation index "__unnamed" "bomb-1")
	(object_create index_fx)
	(custom_animation chief cinematics\animations\chief\level_specific\c20\c20 c20grabindex false)
	(scenery_animation_start index swfce\scenery\index_holder\index_holder C20GrabIndex)
	(scenery_animation_start index_fx swfce\scenery\index_holder\index_holder C20GrabIndex)
...
;	(camera_set inspect_index_1a 180)
	...
	(object_destroy index_shard)
	(object_create index_shard)
	(object_set_permutation index_shard "__unnamed" "bomb-1")
	(objects_attach chief "left hand" index_shard "left hand index")
...
;	(535, make index disappear)
	...
	(effect_new "swfce\scenery\index_holder\effects\nuke" cine_extr_fx)
...
;	(sleep (sound_impulse_time sound\dialog\c20\C20_310_Monitor))
	...
	(object_destroy index_idle)
	(object_create index)
	(object_set_permutation index "__unnamed" "horse-2")
	(object_create index_fx)
	(effect_new "swfce\scenery\index_holder\effects\hooorses" cine_extr_fx)
	(custom_animation chief cinematics\animations\chief\level_specific\c20\c20 c20grabindex false)
	(scenery_animation_start index swfce\scenery\index_holder\index_holder C20GrabIndex)
	(scenery_animation_start index_fx swfce\scenery\index_holder\index_holder C20GrabIndex)
...
;	(camera_set inspect_index_1a 180)
	...
	(object_destroy index_shard)
	(object_create index_shard)
	(object_set_permutation index_shard "__unnamed" "horse-2")
	(objects_attach chief "left hand" index_shard "left hand index")
