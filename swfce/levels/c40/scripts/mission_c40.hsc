...
(script dormant e48_a
	...
	;prim edit - put flood into warthog
	(ai_vehicle_encounter e48_warthog e48_a/fl_w_driver )
	(vehicle_load_magic e48_warthog "driver" (ai_actors e48_a/fl_w_driver ))
	(ai_vehicle_encounter e48_warthog e48_a/fl_w_gunner )
	(vehicle_load_magic e48_warthog "gunner" (ai_actors e48_a/fl_w_gunner ))
...
(script dormant e46_speech
	...
	(vehicle_load_magic c2_gho_b "driver" (ai_actors e46_c/fl_pilot_b ))
	(ai_vehicle_encounter c2_gho_a e46_c/fl_pilot_a )
	(vehicle_load_magic c2_gho_a "driver" (ai_actors e46_c/fl_pilot_a ))
	;Debug
)	
...
; 	(unit_set_enterable_by_player e40_a_ban_2 0)
	...
	;prim edit - place sentinels. kill one by the door as the player approaches
	(ai_place e40_b/sentinels_a)
	(ai_place e40_b/sacrifice)
	
	(sleep 30)
	(ai_magically_see_encounter e40_b e41_a)
	(ai_kill e40_b/sacrifice)
...
; skip-to encounters
(script static void skipto_e22
	(switch_bsp 10)
	(volume_teleport_players_not_inside null_volume e22)
	(wake e22_a)
	(kill_music)
)
...
(script dormant music_c40_10
	...
	(if play_music_c40_10_alt (begin 
									(sound_looping_set_alternate "swfce\levels\c40\music\c40_10" 1)
...
(script dormant music_c40_11
	...
	(sound_looping_start "swfce\levels\c40\music\c40_11" none 1)
	(if debug (print "music 11 in..."))

	(sleep_until (or play_music_c40_11_alt
				  (not play_music_c40_11)) 1 global_delay_music)
	(if play_music_c40_11_alt (begin 
								(sound_looping_set_alternate "swfce\levels\c40\music\c40_11" 1)
	...
	(sound_looping_stop "swfce\levels\c40\music\c40_11")
...
(script static void kill_music
	(if debug (print "killing all music..."))
	(set play_music_c40_01 false)
	(set play_music_c40_01_alt false)
	(set play_music_c40_02 false)
	(set play_music_c40_02_alt false)
