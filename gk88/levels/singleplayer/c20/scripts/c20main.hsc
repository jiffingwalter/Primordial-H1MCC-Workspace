...
(script dormant enc8
	...
	; Place units for all difficulties and make them standby
	(ai_place enc8)
	
	; If the main carrier sees player, call others to attack
	(sleep_until
		(= "5" (ai_status enc8/leaper))
	)
	(ai_command_list_advance enc8)
	(ai_magically_see_players enc8)
	(ai_attack enc8)
	
	; Start alternate music
	(sound_looping_set_alternate "gk88\levels\singleplayer\c20\music\c20_05" true)
	...
	; End moosic
	(sound_looping_stop "gk88\levels\singleplayer\c20\music\c20_05")
)
...
(script dormant enc7
	...
	; Wake the spawner if hard mode

	(if (or (= "hard" (game_difficulty_get_real))(= "impossible" (game_difficulty_get_real)))
		(wake enc7_spawner)
	)
...
(script dormant enc6
	...
	; Stop old music, start new music
	(sound_looping_stop "levels\c20\music\c20_01")
	(sound_looping_start "gk88\levels\singleplayer\c20\music\c20_05" none 1)
)
...
(script dormant enc1
	...
	; Place flood runner to spook player
	(ai_place enc1/spook)
	...
	; Fire up the music if not easy or normal
	(if (or (= "hard" (game_difficulty_get_real))(= "impossible" (game_difficulty_get_real)))
