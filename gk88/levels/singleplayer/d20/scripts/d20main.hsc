...
(script dormant enc6_5
	...
	(wake enc6_5_manager)
	(effect_new "gk88\sounds\ambience\sound_scenery\spooky\flood_wave_approach" flood_roar)
)
...
(script dormant enc4_6
	...
	; MUZAK!
	(sound_looping_stop "gk88\levels\singleplayer\d20\music\d20_03")
...
(script dormant enc4_3
	...
	; MUZAK!
	(sound_looping_start "gk88\levels\singleplayer\d20\music\d20_03" none 1)
...
;	)
	...
	; MUZAK!
	(sound_looping_set_alternate "gk88\levels\singleplayer\d20\music\d20_03" true)
	(sleep 60)
...
(script dormant section4
	...
	; Place "ambient" units and make them blind until player leaves the trigger
	(ai_place enc4_0)
	(ai_set_blind enc4_0 1)
	(sleep 150)
	(ai_magically_see_players enc4_0)
	(ai_set_blind enc4_0 0)
...
(script dormant enc1_1
	...
	(ai_place enc1_1)
	(ai_set_blind enc1_1/infs 0)
	(ai_set_deaf enc1_1/infs 0)
	(create_flood_captain)
...
(script static void preload_textures
	...
	(object_type_predict "gk88\characters\covenant\elite\elite")
	(object_type_predict "gk88\characters\covenant\grunt\grunt")
	(object_type_predict "gk88\characters\flood\floodcarrier\floodcarrier")
	(object_type_predict "gk88\characters\flood\floodcmb_elite\floodcmb_elite")
	(object_type_predict "gk88\characters\flood\floodcmb_human\floodcmb_human")
)
